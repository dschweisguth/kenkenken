...
RSpec.describe Box::Product do
  describe '.new' do
    it "rejects 0 locations" do
      expect { Box::Product.new 1, 1, [] }.to raise_error "locations must contain >= 1 locations, but is empty"
    end
  end

  describe '#solve' do
    it "solves a one-cell box" do
      box = Box::Product.new 2, 1, [[0, 0]]
    ...
    it "solves a two-cell box" do
      box = Box::Product.new 2, 2, [[0, 0], [1, 0]]
